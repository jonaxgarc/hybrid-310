const privacySpanish = {
  ...
  'The website uses FormSubmit to deliver form entries to the Hybrid 310 email inbox. FormSubmit processes the submitted information for that delivery. Google Maps is opened only when you choose a map or review link. This site does not currently use advertising trackers or analytics cookies.': 'El sitio utiliza FormSubmit para enviar los formularios al correo electrónico de Hybrid 310. FormSubmit procesa la información enviada para realizar esa entrega. Google Maps solo se abre cuando eliges un enlace de mapa o reseñas. Actualmente, este sitio no utiliza rastreadores publicitarios ni cookies de análisis.',
